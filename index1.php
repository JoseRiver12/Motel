...
<head>
    ...
    <link rel="stylesheet" href="jquery.mobile/themes/maria.min.css">
...
<body>
    <div data-role="page" data-theme="c">
        <div data-role="header">
            ...
            <h1><img src="images/Captura.gif" alt=""></h1>
           
        </div>
        <div data-role="main">
            <div data-role="navbar">
                <ul>
                    <li><a data-icon="grid" href="acerca de.php">Acerca de</a></li>
                    <li><a data-icon="star" href="HOTEL.php">HOTEL</a></li>
                    <li><a data-icon="star" href="iniciar-sesion.php">Iniciar Sesion</a></li>

                </ul>
            </div>

            <div data-role="content">
		        <img src="images/xa.jpg" style="height:600px; width: 100%"> 
